package com.kh.homework.sort.example;
...
public class Exam_SelectSort {
	public static void main(String [] args)
	{
		...
		// 1. 최소값의 값을 구하는 방법으로
		// 2. 배열의 값을 교환
		// 3. min값은 최소값이 아니라 인덱스 값 저장
		// 4. 최소값을 찾는 범위가 시작은 1이 되고 점점 증가,
		//    바꿔야 하는 자리는 0부터 시작해서 1씩 증가
...
//		int [] arrs = {2, 5, 4, 1, 3};
//		int min = 0;
//		// min은 최소값을 저장하는 것이 아니라 최소인 인덱스의 값을 저장해야함
